...
exports['default'] = {
  ...
  props: (0, _propsUtil.initDefaultProps)((0, _extends3['default'])({}, (0, _Tree.TreeProps)(), {
    expandAction: _vueTypes2['default'].oneOf([false, 'click', 'doubleclick', 'dbclick'])
  }), {
    showIcon: true,
    expandAction: 'click'
  }),
  ...
  render: function render() {
    ...
    (0, _warning2['default'])(!this.$listeners.doubleclick, '`doubleclick` is deprecated. please use `dbclick` instead.');
    var treeProps = {
